						...
						<form action="alterarTipoAtendimento" method="post">
							<div class="span12">
								...
								<label>Nome do Tipo de Atendimento</label> 
									<input type="text" required="" name="des_tipo_atendimento" id="des_tipo_atendimento" value="${tipoAtendimento.des_tipo_atendimento}" maxlength="80" class="input-small span12"><br>
