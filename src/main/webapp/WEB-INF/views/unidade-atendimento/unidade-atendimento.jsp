						...
						<div class="span12">
							<form:form commandName="unidadeAtendimento"
								...
								<div class="row-fluid">
									<div class="span10">
										<label>Nome da Unidade de Atendimento</label> <input
											...
											name="nom_uni_atendimento" required=""><br>
									</div>
									<div class="span2">
										<label class="">CEP:</label> <input type="text" name="num_cep"
											class="input-small span12" required="">
									</div>
								</div>
								...
								<div class="row-fluid">
									...
									<div class="span1">
										<label class="">N°:</label> <input type="text"
											name="num_numero" class="input-small span12" required="">
									</div>
									<div class="span3">
								...
								<div class="row-fluid">
									<div class="span2">
										<label class="">Telefone 1:</label> <input type="text"
											name="num_tel1" class="input-small span12" required="">
									</div>
									<div class="span2">
										<label class="">Telefone 2:</label> <input type="text"
											name="num_tel2" class="input-small span12">
									</div>
									<div class="span2">
										<label class="">Telefone 3:</label> <input type="text"
											name="num_tel3" class="input-small span12">
									</div>									
								</div>
								<div class="row-fluid">
								...
								<div class="span12 text-right">
									...
									<a href="../unidadeAtendimento/" style="color: #fff"
